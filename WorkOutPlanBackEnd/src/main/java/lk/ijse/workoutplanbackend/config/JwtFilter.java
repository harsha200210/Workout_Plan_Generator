package lk.ijse.workoutplanbackend.config;
...
public class JwtFilter extends OncePerRequestFilter {
    ...
    public void saveOrUpdateLoginToken(String token) {
        loginDataRepository.save(new LoginData(1,token));
    }

    public String getUserName() {
        LoginData referenceById = loginDataRepository.findById(1);
        System.out.println(referenceById);
        return jwtUtil.getUsernameFromToken(referenceById.getToken());
    }
